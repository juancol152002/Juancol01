...
const ProfileModal = ({ isOpen, onClose }) => {
    ...
    const fetchProfile = async () => {
        ...
        try {
            const response = await fetch('http://127.0.0.1:8000/api/users/perfil/', {
    ...
    const handleUpdateProfile = async () => {
        ...
        try {
            const response = await fetch('http://127.0.0.1:8000/api/users/perfil/actualizar/', {
                method: 'POST',
                headers: { 'Authorization': `Bearer ${token}` },
                body: formData
            });
    ...
    const handleChangePassword = async () => {
        ...
        try {
            const response = await fetch('http://127.0.0.1:8000/api/users/perfil/password/', {
                method: 'POST',
                headers: {
